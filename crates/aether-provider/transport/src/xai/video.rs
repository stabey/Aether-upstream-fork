...
/// CPA exposes native xAI video requests under /v1 and its OpenAI adapter under /openai/v1.
...
/// Convert the OpenAI video request contract to xAI, matching CPA's handler.
